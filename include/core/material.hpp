...
class Material
{
  public:
    ...
    virtual std::optional<Ray> scatter(const Ray& ray, SurfaceIntersection& intersection, rgb_color& attenuation) const
    {
        return std::nullopt;
    }
};
...
class Lambertian : public Material
{
  public:
    ...
    std::optional<Ray> scatter(const Ray& ray, SurfaceIntersection& intersection, rgb_color& attenuation) const override;
    virtual ~Lambertian() {};
